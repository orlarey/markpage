...
\title{Letterhead — sender / recipient / signature}
...
Three dedicated fences for correspondence: \texttt{sender} (top-left),
\texttt{recipient} (DL-window positioned, for the FR envelope window), and
\texttt{signature} (right-aligned at the end).
