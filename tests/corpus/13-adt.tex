...
The \texttt{adt} fence renders BNF-ish type definitions with aligned
...
\section{Warnings on unrecognised lines}

A typo in the head (here \texttt{:=} instead of \texttt{::=}) is surfaced as a
