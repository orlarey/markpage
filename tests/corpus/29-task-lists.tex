...
GitHub-style task lists: \texttt{- [ ]} for an open item, \texttt{- [x]} for a done
one. They render as checkboxes.


\begin{itemize}
  \item[$\boxtimes$] Write the spec
  \item[$\boxtimes$] Implement the parser
  \item[$\square$] Add the tests
  \item[$\square$] Ship it
\end{itemize}


Nested under a regular list:
...
\begin{itemize}
  \item[$\boxtimes$] Scope agreed
  \item[$\square$] Budget signed off
\end{itemize}
  \item Build

\begin{itemize}
  \item[$\square$] Backend
  \item[$\square$] Frontend
\end{itemize}
\end{enumerate}
