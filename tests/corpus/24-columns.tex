...
\title{Columns — side-by-side layout}
...
A \texttt{::: columns} fenced div splits its content at each \texttt{---} into equal
columns. Two \texttt{---} give three columns.
...
Column one with a short paragraph.
