...
\textbf{markpage} est un éditeur qui produit des PDF prêts à imprimer ou à
...
markpage utilise une convention qui s'appelle \textbf{Markdown}. Vous écrivez
...
markpage garde \textbf{tous vos documents} dans le navigateur. La liste se
...
\href{https://github.com/orlarey/markpage}{GitHub}.
