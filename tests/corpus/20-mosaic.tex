...
\title{Mosaic — justified image walls}
...
A \texttt{mosaic} fence packs whole images (never cropped) into full-width
rows with no gaps — a clean rectangle. \texttt{height=} tunes the density;
\texttt{gap=} adds a gutter.
