...
Unicode in math (exercises back-conversion): $\alpha  \to  \beta $, $\mathbb{N} \subset  \mathbb{R}$, $\forall x \in  \llbracket 0, n\rrbracket $.
...
Pre-wrapped \texttt{align*} inside a math fence (must not be re-wrapped in \texttt{\textbackslash{}[..\textbackslash{}]}):
