...
const FR = {
  ...
  // ---- border-side options -----------------------------------------
  'border-side.none': 'Aucune',
  'border-side.all': 'Toutes',
  'border-side.left': 'Gauche',
  'border-side.right': 'Droite',
  'border-side.top': 'Haut',
  'border-side.bottom': 'Bas',
  'border-side.top-bottom': 'Haut + Bas',
  'border-side.left-right': 'Gauche + Droite',
...
const EN: Record<keyof typeof FR, string> = {
  ...
  // ---- border-side options -----------------------------------------
  'border-side.none': 'None',
  'border-side.all': 'All',
  'border-side.left': 'Left',
  'border-side.right': 'Right',
  'border-side.top': 'Top',
  'border-side.bottom': 'Bottom',
  'border-side.top-bottom': 'Top + Bottom',
