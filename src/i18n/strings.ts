...
const FR = {
  ...
  'toolbar.atelier': 'Atelier de style',
  'toolbar.atelier-title':
    'Composer le style du document — format, polices, couleur — en direct (Cmd/Ctrl+Maj+A)',
  ...
  'file-menu.new-from': 'Nouveau à partir de…',
  'file-menu.extract-style': 'Extraire un style…',
  'file-menu.set-default-style': 'Définir comme style par défaut',
  'file-menu.unset-default-style': 'Retirer le style par défaut',
  'new-from.title': 'Nouveau document à partir de…',
  'new-from.empty': 'Aucun autre document dans la bibliothèque.',
  'new-from.cancel': 'Annuler',
  'extract-style.name': 'Style de {name}',
  'extract-style.empty': 'Ce document n’a pas de réglage de style à extraire.',
...
const EN: Record<keyof typeof FR, string> = {
  ...
  'toolbar.atelier': 'Style atelier',
  'toolbar.atelier-title':
    'Compose the document style — format, fonts, colour — live (Cmd/Ctrl+Shift+A)',
  'toolbar.style': 'Format',
  ...
  'file-menu.new-from': 'New from…',
  'file-menu.extract-style': 'Extract a style…',
  'file-menu.set-default-style': 'Set as default style',
  'file-menu.unset-default-style': 'Remove default style',
  'new-from.title': 'New document from…',
  'new-from.empty': 'No other document in the library.',
  'new-from.cancel': 'Cancel',
  'extract-style.name': 'Style from {name}',
  'extract-style.empty': 'This document has no style settings to extract.',
  'file-menu.open': 'Open…',
